...
const HealthResult = ({health, food}) => {
  return (
    <div className='flex flex-col min-w-[45%] card'>
      ...
      <div className='w-full flex flex-col items-start font-semibold justify-between px-5 py-3 border border-blueSpecial rounded-[5px] '>
        <h1 className='text-[18px] text-secondary py-2'>HEALTH STATE <span className='text-[#fff] pl-4'>{health}</span></h1>
        <h1 className='text-[18px] text-secondary py-2'>FOOD CONSUMPTION GOAL <span className='text-[#fff] pl-4'>{food}</span></h1>
      </div>
    </div>
  )
}
