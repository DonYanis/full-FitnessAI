  ...
  return (
    <div className='flex flex-col min-w-[45%] card'>
      ...
      <div className='flex flex-col items-start font-semibold justify-between px-5 py-3 border border-blueSpecial rounded-[5px] '>
        <h1 className='text-[18px] text-secondary py-2'>TRAINING INTENSITY <span className='text-[#fff] pl-4'>MEDIUM (3-4 A WEEK)</span></h1>
        <h1 className='text-[18px] text-secondary py-2'>RECOMMENDED TRAINING PROGRAM <span className='text-[#fff] pl-4'>PPL</span></h1>
      </div>
    </div>
  )
}
